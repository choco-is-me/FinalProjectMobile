...
public class StopWatchService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if(StopWatch.universal.isRunning()){
            StopWatch.universal.start(new TimerTask() {
                @Override
                public void run() {
                    updateNotification(StopWatchService.this,true);
                }
            });
        }else{
...
//        if(update)
//            StopWatch.universal.incrementStopWatch();


        String[] texts = TimeUtils.convertMilli(StopWatch.universal.getMilliSecondsElapsed());
//
        ...
        String laps = StopWatch.universal.getLapCounter();
        ...
        Notification customNotification = new NotificationCompat.Builder(context, CHANNEL_ID)
                ...
                .addAction(R.drawable.ic_add_black_24,
                        StopWatch.universal.getStopString(),
                        getAction(context,STOP_ACTION))
                .addAction(R.drawable.ic_add_black_24,
                        StopWatch.universal.getLapString()
    ...
    public static PendingIntent getAction(Context context, String action){
        Intent pendingIntent = new Intent(context, StopWatchBroadcastReceiver.class);
