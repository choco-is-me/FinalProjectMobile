package com.moh.alarmclock.ListView;
...
public class ListView<T>{
    ...
    public ListView(android.widget.ListView v, ArrayAdapter<T> adapter, List<T> list, Context c){
        this.listView = v;
    ...
    public ListView(android.widget.ListView v, ArrayAdapter<T> adapter, List<T> list, Context c, Animation in, Animation out){
        this.listView = v;
        this.arrayAdapter = adapter;
        this.list = list;
        this.c = c;
...
//            if(animation){
//                Animation.animateNoTag(listView,View.VISIBLE,Animation.APPEAR);
//            }
