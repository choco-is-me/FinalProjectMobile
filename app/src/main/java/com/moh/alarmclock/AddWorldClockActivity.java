...
import com.moh.alarmclock.Clock.MoWorldClock.MoCities.MoCityCoordinate;
import com.moh.alarmclock.Clock.MoWorldClock.MoCities.MoCityRecyclerAdapter;
import com.moh.alarmclock.Clock.MoWorldClock.MoWorldClock;
import com.moh.alarmclock.Clock.MoWorldClock.MoWorldClockManager;


public class AddWorldClockActivity extends MoSmartActivity implements MoCityRecyclerAdapter.MoOnCitySelectedListener, MoWorldClockManager.MoOnWorldClockAvailableObserver {
    ...
    public static void startActivity(Context context) {
        context.startActivity(new Intent(context, AddWorldClockActivity.class));
    }

    public static void startActivityForResult(Activity a, int code) {
        a.startActivityForResult(new Intent(a, AddWorldClockActivity.class), code);
    }
}
