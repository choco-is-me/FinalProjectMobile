...
public class Vibration implements MoLoadable {

    public static Vibrator v;

    private final String SEP_KEY = "&afsvdviol&";

    private VibrationTypes type;

    private boolean isActive;

    public Vibration(VibrationTypes t, boolean isActive){
        this.type = t;
    ...
    public VibrationTypes getType() {
        return type;
    }

    public void setType(VibrationTypes type) {
        this.type = type;
    }
