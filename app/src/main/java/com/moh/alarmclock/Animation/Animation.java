package com.moh.alarmclock.Animation;
...
public class Animation {
    ...
    public static SparseArray<android.view.animation.Animation> animations = new SparseArray<>();
    ...
    public static android.view.animation.Animation get(int key){
    ...
    public static void animate(View v, int visibility, int animation, Id id, boolean shouldAnimate){
        if(v.getVisibility() != visibility && shouldAnimate){
    ...
    public static void animate(View v, int visibility, int animation, Id id){
        if(v.getVisibility() != visibility){
            animate(v,animation,id);
            v.setVisibility(visibility);
        }
    ...
    // only animates if there is nothing in the log
    private static void animate(View v, int animation, Id id){
        String key = v.getId()+ id.getSId() ;
        Boolean shouldAnimate = log.get(key);
        if(shouldAnimate == null){
            v.startAnimation(get(animation));
            // we dont do it again
