...
import com.moh.alarmclock.Clock.MoWorldClock.MoWorldClockRecyclerAdapter;

public class WorldClockSectionManager implements MoOnBackPressed, MainActivity.SelectModeInterface {
    ...
    public WorldClockSectionManager(MainActivity a) {
        this.activity = a;
    }
    ...
    private void initEmptyView() {
        ...
        this.emptyView.findViewById(R.id.button_emptyWorldClock_addCity)
                .setOnClickListener((v) -> AddWorldClockActivity.startActivityForResult(activity, MainActivity.ADD_WORLD_CLOCK_CODE));
    }
    ...
    private void initToolbar() {
        ...
        this.toolBar.hideMiddle()
                ...
                .setRightOnClickListener((v) -> AddWorldClockActivity.startActivityForResult(activity, MainActivity.ADD_WORLD_CLOCK_CODE));
    }
