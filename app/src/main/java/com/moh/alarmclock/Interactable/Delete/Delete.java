...
public class Delete {
    ...
    // mutual class
    private ListDeletable listAdapter;
    ...
    public Delete(Activity a, ListDeletable listDeletable){
        this.activity = a;
        this.listAdapter = listDeletable;
    }

    public Delete setListDeletable(ListDeletable listDeletable){
        this.listAdapter = listDeletable;
        return this;
    }

    public Delete setDeleteViews(int ... views){
    ...
    public Delete setNormalViews(int ... views){
    ...
    public Delete setVisibleAnimation(int a){
        this.visibleAnimation = a;
        return this;
    }

    public Delete setGoneAnimation(int a){
    ...
    public Delete setCounterView(int ctv, String message){
    ...
    public Delete setDeleteButton(int deleteButton){
        ...
        this.deleteButton.setOnClickListener(view -> {
            ...
            h.postDelayed(() -> {
                ...
                cancel();
                RunnableUtils.runIfNotNull(onDeletePressed);
    ...
    public Delete setProgressBar(int progressBar){
        this.progressBar = activity.findViewById(progressBar);
        this.progressBar.setIndeterminate(false);
        return this;
    }

    public Delete setOnDeletePressed(Runnable r){
        this.onDeletePressed = r;
        return this;
    }

    public Delete showOnlyOneActionAtTime(boolean b){
        this.showOneActionAtTime = b;
        return this;
    }

    public Delete setSelectAllCheckBox(int selectAll){
    ...
    private void activateDeleteMode(){
        for(View v: deleteViews){
            Animation.animateNoTag(v,visible,visibleAnimation);
        }
        for(View v: normalViews){
            Animation.animateNoTag(v,invisible,goneAnimation);
        }
        updateCounter();
    }
